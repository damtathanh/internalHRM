  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "bg-card dark:data-[state=unchecked]:bg-card-foreground dark:data-[state=checked]:bg-primary-foreground pointer-events-none block size-4 rounded-full ring-0 data-[state=checked]:ml-[calc(100%-2px)] data-[state=unchecked]:ml-0",
        )}
      />
    </SwitchPrimitive.Root>
  );
